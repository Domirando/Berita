...
class SearchFragment : Fragment(), NewsTypeAdapter.OnItemClickListener, NewsCardAdapter.OnItemClickListenerCard, Communicator  {
    ...
    override fun onCreateView(
        ...
        binding.search.addTextChangedListener(object : TextWatcher {
            override fun afterTextChanged(s: Editable?) {
                ...
                cardsAdapter = NewsCardAdapter(filteredList as MutableList<NewsCard>, this@SearchFragment)
